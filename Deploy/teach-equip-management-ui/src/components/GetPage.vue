...
const allSupplier = async () => {
  const response = await axios.get("http://localhost:8080/api/toolmanage/all-supplier", {
    headers: {
...
const allTool = async () => {
  const response = await axios.get(
    "http://localhost:8080/api/toolmanage/all-tools-include-supplier",
    {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("access_token"),
      },
...
const allRoles = async () => {
  const response = await axios.get("http://localhost:8080/api/usermanage/all-roles");
  roles.value = response.data.data;
};

const allInventories = async () => {
  const inventories = await axios.get(
    "http://localhost:8080/api/inventorymanage/all-inventories",
    {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("access_token"),
      },
...
const allInvoicess = async () => {
  const response = fetch("http://localhost:8080/api/toolmanage/all-invoices", {
    method: "GET",
    headers: {
...
const allApprovalRequest = async () => {
  const response = await axios.get(
    "http://localhost:8080/api/inventorymanage/all-approval-requests",
    {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("access_token"),
      },
...
const accountById = async (userId) => {
  const response = await axios.get(
    `http://localhost:8080/api/usermanage/user/find/${userId}`,
    {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("access_token"),
      },
...
const inventoryById = async (inventoryId) => {
  const inventory = await axios.get(
    `http://localhost:8080/api/inventorymanage/inventory/find/${inventoryId}`,
    {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("access_token"),
      },
...
const toolById = async (toolId) => {
  const tool = await axios.get(
    `http://localhost:8080/api/toolmanage/tool/find/${toolId}`,
    {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("access_token"),
      },
