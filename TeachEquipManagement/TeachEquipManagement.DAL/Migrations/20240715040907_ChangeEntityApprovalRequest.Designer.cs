...
namespace TeachEquipManagement.DAL.Migrations
{
    ...
    [Migration("20240715040907_ChangeEntityApprovalRequest")]
    partial class ChangeEntityApprovalRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeachEquipManagement.DAL.Models.ApprovalRequest", b =>
                {
                    ...
                    b.Property<DateTime>("ApproveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 11, 9, 7, 152, DateTimeKind.Local).AddTicks(5600));
                    ...
                    b.Property<DateTime>("RequestDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 11, 9, 7, 152, DateTimeKind.Local).AddTicks(5323));
            ...
            modelBuilder.Entity("TeachEquipManagement.DAL.Models.InventoryHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ActionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 11, 9, 7, 152, DateTimeKind.Local).AddTicks(8660));
            ...
            modelBuilder.Entity("TeachEquipManagement.DAL.Models.Invoice", b =>
                {
                    ...
                    b.Property<DateTime>("InvoiceDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 11, 9, 7, 152, DateTimeKind.Local).AddTicks(3085));
